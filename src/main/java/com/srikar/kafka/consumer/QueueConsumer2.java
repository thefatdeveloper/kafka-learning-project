...
public class QueueConsumer2 {
    ...
    private static final String CONSUMER_ID = "Consumer-2";
 ...
 *
 * Step 2: Run QueueConsumer2 (Terminal 1)
 * Command: mvn exec:java -Dexec.mainClass="com.srikar.kafka.consumer.QueueConsumer2"
